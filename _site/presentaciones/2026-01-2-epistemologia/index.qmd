...
# ![](img/icon-1-A-alfa.png){.icono} Fundamentos del ideal científico {.texto-fig}
...
# ![](img/icon-2-B.png){.icono} El problema de la causalidad {.texto-fig}
...
# ![](img/icon-3.png){.icono} Simplicidad, complejidad y límites{.texto-fig}
...
# ![](img/icon-4-B.png){.icono} Crisis del ideal positivista{.texto-fig}
...
# ![](img/icon-5-C.png){.icono} Racionalidad humana real{.texto-fig}
...
# ![](img/icon-6-B.png){.icono} Salida constructiva: ciencia hoy{.texto-fig}
