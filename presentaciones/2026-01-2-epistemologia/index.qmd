...
# ![](img/icon-1-A-alfa.png){.icono} Fundamentos del ideal científico {.texto-fig style="--sep: 3rem" #bloque-1}
...
# ![](img/icon-2-B.png){.icono} El problema de la causalidad {.texto-fig style="--sep: 3rem" #bloque-2}
...
# ![](img/icon-3.png){.icono} Simplicidad, complejidad y límites {.texto-fig style="--sep: 3rem" #bloque-3}
...
# ![](img/icon-4-B.png){.icono} Crisis del ideal positivista {.texto-fig style="--sep: 3rem" #bloque-4}
...
# ![](img/icon-5-C.png){.icono} Racionalidad humana real {.texto-fig style="--sep: 3rem" #bloque-5}
...
# ![](img/icon-6-B.png){.icono} Salida constructiva: ciencia hoy {.texto-fig style="--sep: 3rem" #bloque-6}
