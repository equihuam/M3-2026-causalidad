...
Lógica, probabilidad y heurística son tres ideas centrales en la historia intelectual del intelecto humano. La teoría de la probabilidad que surge a mediados del siglo XVII, substituyó la certeza de la lógica por una teoría más modesta de la racionalidad. Su aparición ayudó a reconocer que existe una incertidumbre fundamental en la conducta humana. Usamos estas herramientas para decidir cosas, a veces suponiendo que reproducen la forma como [opera nuestra mente](https://www.bbc.com/mundo/noticias-59060022). Pero conviene no olvidar que también importa desde dónde, para qué y bajo qué condiciones decidimos o afirmamos nuestras convicciones. Veremos a cotinuación un ejemplo a este respecto que nos comparte McElreath (2020). Se trata del hipotético ejemplo de *la prueba de sangre para vampirismo*, que nos ayudaría a deciri si alguién es mortal o vampiro. Inicia por pedirnos imaginar que hay un análisis de sangre que detecta correctamente 95% de las veces, la afiliación de un individuo al linaje del conde Drácula y los inmortales vampiros. En notación matemática:
...
que el uno por ciento de las puebas realizadas diagnostican incorrectamente a 
...
lo es (esta es la que llamamos probabilidad *a priori*), lo que anotamos así:
