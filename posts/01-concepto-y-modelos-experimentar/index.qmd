...
Lógica, probabilidad y heurística
son tres ideas centrales en la historia del intelecto humano. A la
aspiración de la lógica aristotélica se agregó a mediados del siglo XVII
la teoría de la probabilidades, que matizó la certeza de la lógica al
aportar una teoría con una postura más modesta en torno a la
racionalidad. Su aparición ayudó a reconocer la existencia de una
incertidumbre fundamental en la conducta humana. @einstein1905 introdujo
el uso de la noción de [heurística](https://psicologiaymente.com/inteligencia/heuristicos-atajos-mentales-pensamiento) (sin definirla), como referencia al uso de la imaginación
creativa a la que recurrimos los seres humanos para descubrir cosas nuevas, desde entonces el término ha florecido con matices diversos en todos los campos de la ciencia y las artes. Usamos estas tres herramientas para *decidir científicamente*, a veces suponiendo que reproducen la forma como [opera nuestra mente](https://www.bbc.com/mundo/noticias-59060022). Veremos a continuación un
ejemplo a este respecto que nos comparte McElreath (2020). Se trata del
hipotético ejemplo de *la prueba de sangre para vampirismo*, que nos
ayudaría a decidir si alguien es mortal o vampiro. Inicia por pedirnos
imaginar que hay un análisis de sangre que detecta correctamente 95% de
las veces, la afiliación de un individuo al linaje del conde Drácula y
los inmortales vampiros. En notación matemática:
...
queremos saber qué está pasando cuando tenemos la fortuna o desgracia de toparnos
...
Por lo tanto, esta es una estimación de la probabilidad de que el amigo sea en realidad un vampiro.
