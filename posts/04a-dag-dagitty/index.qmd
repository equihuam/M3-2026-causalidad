...
Ahora hacemos lo que el **DAG** nos sugiere que es la forma apropiada de
...
2.  **Ajuste estadístico**
    ...
    -   Al incluir esta variable bloqueas el camino de confusión y
        logras estimar e mejor manera el efecto causal de la *sombra* sobre
        el *crecimiento*.
