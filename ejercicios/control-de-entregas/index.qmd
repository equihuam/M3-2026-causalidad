...
tabla_correo <- tabla_correo |>
  ...
  mutate(tipo = if_else(str_detect(str_to_lower(archivo),"ejerc|tarea|descrip|dag|larva|curso|http|aedes|ejercicio3_"),
                        "ejercicio", "lectura"), 
         ...
         id_num = if_else(str_detect(str_to_lower(archivo),"larva|curso|http|aedes|mosquitos"), "3", id_num),
         id_num = if_else(str_detect(str_to_lower(archivo),"ejercicio3_"), "4", id_num)) |> 
  arrange(tipo, id_num)
```
